...
p4tool was created to extend traditional slowdown methods such as ODCM throttling by adding techniques that affect CPU execution and memory behavior independently.
